...
X_test=X_data[0:100]
steering_test = steering_data[0:100]
...
X_train=X_data[100:-1]
steering_train = steering_data[100:-1]
...
# create model
	...
	#compile model
	model.compile(Adam(lr=1e-10), 'mse')
else:
	print('loading model')
...
for n in range(-5,-10,-5):
	...
	model.fit_generator(train_gen, samples_per_epoch=min(len(X_train),NUMBER_PHOTO*5), nb_epoch=nb_epochs)
